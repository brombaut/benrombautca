...
const hikes: Hike[] = [
  ...
  },
  {
    ...
    location: "Adirondacks, New York, USA",
    description: "<p><strong>Cascade Mountain (4,098 ft)</strong> and <strong>Porter Mountain (4,059 ft)</strong> are two of the Adirondack 46ers, the 46 highest peaks in New York’s Adirondack Park. Cascade is one of the most popular of the 46ers due to its relatively short and accessible trail, while Porter is often done as a side trip from Cascade, adding a bit more distance to the hike.</p><p>This hike marked <strong>#4 and #5</strong> on my journey toward becoming an <strong>Adirondack 46er</strong>. It was also my <strong>first winter hike of the year</strong>, and my <strong>first hike where I would be using microspikes and snowshoes</strong>, so we wanted to do a relatively easy hike to test out all the equipment and get used to it.</p><p>The microspikes were absolutely amazing. We were able to walk straight up large sheets of ice that had formed on the steep trail without slipping at all. There had been some recent rain that froze over, and there is no way we would have been able to make it up the mountain without them. We only really used our snowshoes once we got over to Porter Peak, which was less well traveled and had deeper, less compact snow, but it was still a lot of fun to finally get to use them.</p>",
    images: [
