...
const hikes: Hike[] = [
  ...
  },
  {
    ...
    location: "Adirondacks, New York, USA",
    description: "<p>The Dix Range is a ridge of five Adirondack 46ers deep in the High Peaks Wilderness. It was a beautiful day, but I arrived around 6:30 in the morning to find the main parking lot already full, so I had to park at the overflow lot and walk an extra 5km just to reach the trailhead.</p><p>I did the loop clockwise, heading up the Beckhorn Trail to the Beckhorn (4,485 ft), a sharp shoulder on the eastern ridge of Dix, before continuing out to the summit of Dix Mountain (4,857 ft). From there I traversed west across the range to Hough Peak (4,400 ft), then South Dix (4,060 ft), then an out-and-back to Grace Peak (3,994 ft), and finally Macomb Mountain (4,405 ft). The descent was down the Macomb Slide, a steep and exposed landslide chute that was pretty sketchy in places.</p><p>All told it was about a 35km day with nearly 1,900 meters of elevation gain. Dix, Hough, South Dix, Grace, and Macomb are all Adirondack 46ers, bringing my total to #8 through #12.</p>",
    images: [
