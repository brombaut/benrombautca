...
const aboutMe: AboutMe = {
  description: [
    ...
    },
    {
      section: "education",
      paragraph:
        "I earned a Bachelor of Science in Software Engineering from the University of New Brunswick in May 2019. I also graduated from the Faculty of Computer Science's Co-operative Education Program alongside my degree, completing multiple work terms in both academia and industry."
    },
    {
      section: "current",
      paragraph:
