...
const aboutMe: AboutMe = {
  description: `
  <p>
  I'm a Software Engineering Researcher with the Centre for Software Excellence at Huawei Canada, where I work with a team researching bleeding edge topics and tools related to software engineering for high-performance computing and heterogeneous computing systems. I earned my M.Sc. from the School of Computing at Queen's University in 2022, and my B.Sc. in Software Engineering from the University of New Brunswick in 2019.
  </p>
  <p>
