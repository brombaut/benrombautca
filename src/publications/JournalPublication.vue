  ...
  <li class="journal-publication">
    <div class="publication-card">
      <div class="publication-header">
        <span class="publication-badge journal-badge">Journal</span>
        <span class="publication-date">{{ journal.month }} {{ journal.year }}</span>
      </div>
      ...
      <div class="publication-authors">
        <span
          ...
          :key=a
          class="author">
          <span :class="{ 'author-highlight': authorIsBen(a) }">{{ a }}</span><span v-if="idx < journal.authors.length - 1">, </span>
        </span>
      </div>
      ...
      <div class="publication-links" v-if="journal.links.length > 0">
        <a
